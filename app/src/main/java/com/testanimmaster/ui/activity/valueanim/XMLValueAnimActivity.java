...
public class XMLValueAnimActivity extends AppCompatActivity implements RecycleViewCallback {
    RecyclerView rvMain;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xmlvalue_anim);
    ...
    public void onItemClick(View view, int position) {
        ...
        switch (position) {
            case 0:
                intent.putExtra("animFlg", "XMLBasicValueAnim");
                break;
        }
